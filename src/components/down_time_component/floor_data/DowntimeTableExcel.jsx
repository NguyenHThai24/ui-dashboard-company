...
const DowntimeTableExcel = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.post("http://192.168.30.245:8989/downtime/ExportExcel", {
        factory: "LHG",
        ...
        <Grid container  alignItems="center" className="mb-2 flex gap-4">
          <Grid item sx={{}}>
            <DatePicker
              ...
              renderInput={(params) => <TextField {...params} fullWidth className={classes.textField} />}
          ...
          <Grid item sx={{}}>
            ...
            >
                <img src="../../../../public/images/excel.png" style={{height: "40px", width: "40px"}}/>
            </Button>
          </Grid>
        </Grid>
