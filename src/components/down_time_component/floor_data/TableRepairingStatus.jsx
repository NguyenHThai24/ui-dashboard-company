...
const MechanicTable = ({ floor, date, line }) => {
  ...
  return (
    <div
      className="rounded-lg font-bold bg-white grid grid-cols-1"
    ...
    >
      ...
      <TableContainer sx={{
        maxHeight: "350px", marginTop: "10px", paddingLeft: "2px", paddingRight: "2px", width:'100%', overflow:'scroll',
          ...
          {loading ? (
            ...
            <Typography variant="body1" color="error" sx={{ textAlign: "center", padding: "20px" }}>
              Error: {error}
            </Typography>
            ...
            <Table  sx={{ overflow:'auto',tableLayout:'fixed', width:'100%', position:'relative'}}>
              <TableHead
                sx={{
              ...
              >
                <TableRow>
                  <TableCell sx={{ fontSize: "13px", width:'150px' }}>Line</TableCell>
                  <TableCell sx={{ fontSize: "13px", width:'500px' }}>Machine Name</TableCell>
                  <TableCell sx={{ fontSize: "13px", width:'150px' }}>Request Time</TableCell>
                  <TableCell sx={{ fontSize: "13px", width:'150px' }}>Waiting</TableCell>
                  <TableCell sx={{ fontSize: "13px", width:'150px' }}>Repairing</TableCell>
                  <TableCell sx={{ fontSize: "13px", width:'150px' }}>Done</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {tableRepairing.Name_en.map((_, index) => {
                  ...
                  return (
                    ...
                    >
                      <TableCell sx={{ fontSize: "13px", textAlign:"center" }}>{tableRepairing.floors[index] || ""}</TableCell>
                      <TableCell sx={{ fontSize: "13px" }}>{tableRepairing.Name_en[index]}</TableCell>
                      <TableCell sx={{ fontSize: "13px",  textAlign:"center" }}>{tableRepairing.request[index] || ""}</TableCell>
