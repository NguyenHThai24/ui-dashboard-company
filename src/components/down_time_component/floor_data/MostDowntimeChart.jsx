...
const MostDowntimeChart = ({ floor, line, date, cuttingFitting }) => {
  const { chartMostDowntime, loading, error } = useSelector(
  ...
  return (
    ...
    >
      ...
      >
        {t['Most Downtime By Machine Type (Min)']}
      </Typography>
      <CardContent
        sx={{
          height: '100%',
