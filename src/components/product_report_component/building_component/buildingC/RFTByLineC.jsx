...
import { fetchRFTByLine } from "@/apis/product_report_api/buildingAPI/BuildingCAPI";
import { setLoading, setError } from "@/redux/loading/loadingSlice";

const RFTByLineC = ({ selectedDate }) => {
  const dispatch = useDispatch();
  const { chartDataRFT, loading, error } = useSelector((state) => ({
    chartDataRFT: state.buildingc.chartDataRFT,
