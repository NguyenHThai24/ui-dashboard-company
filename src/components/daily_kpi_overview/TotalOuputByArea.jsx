      ...
      <div className="bg-white p-2 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-3 gap-4 text-center my-6">
          ...
          <div className="border border-green-400 px-2 py-5 rounded-xl">
            ...
            <div className="my-4">
              <span className="font-bold text-4xl pr-2">77,120   <span className="font-bold text-sm">PAIRS</span></span>
          ...
          <div className="border border-green-400 px-2 py-5 rounded-xl">
            ...
            <div className="my-4">
              <span className="font-bold text-4xl pr-2">41,217 <span className="font-bold text-sm">PAIRS</span></span>
          ...
          <div className="border border-green-400 px-2 py-5 rounded-xl">
            ...
            <div className="my-4">
              <span className="font-bold text-4xl pr-2">46,180 <span className="font-bold text-sm">PAIRS</span></span>
