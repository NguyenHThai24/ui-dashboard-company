        ...
        <div className="grid grid-cols-2 items-center py-6">
            ...
            <div className="grid grid-rows-4 gap-4">
                <div className="border-l-4 border-gray-500">
                    <p className="font-semibold text-gray-500 text-sm pl-2">Cutting Worker</p>
                    <p className="font-bold pl-2">180</p>
                </div>
                <div className="border-l-4 border-gray-500">
                    <p className="font-semibold text-gray-500 text-sm pl-2">Stockfitting Worker</p>
                    <p className="font-bold pl-2">1264</p>
                </div>
                <div className="border-l-4 border-gray-500">
                    <p className="font-semibold text-gray-500 text-sm pl-2">Stitching Worker</p>
                    <p className="font-bold pl-2">6997</p>
                </div>
                <div className="border-l-4 border-gray-500">
                    <p className="font-semibold text-gray-500 text-sm pl-2">Assembly Worker</p>
